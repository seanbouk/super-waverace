...
so the mode-7 strip above the waterline still matches), an optional `gravity`
(airborne fall rate, default 36 — Mars runs at 18) and an `ambient` RGB multiplier (`#ffffff` =
